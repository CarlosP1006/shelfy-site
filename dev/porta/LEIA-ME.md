# Porta de entrada do shelfy (link curto sem o usuário do GitHub)

Estes arquivos formam um site mínimo que só redireciona para o site do shelfy. Ele fica numa **organização gratuita do GitHub** com o nome da marca, então o link que aparece na bio e nos posts não mostra o usuário pessoal. O site principal, os endereços cadastrados no Google e este repositório continuam exatamente iguais.

- `https://NOME-DA-ORG.github.io/` → abre o site do shelfy.
...
5. Settings do repositório → **Pages** → *Deploy from a branch* → `main` / `(root)` → Save. Em até 10 minutos `https://NOME.github.io/` abre o shelfy.
