...
for (const file of ['dev/products.sample.json', 'dev/fixtures/hostile.json', 'dev/fixtures/legado-4-digitos.json']) {
  for (const entry of JSON.parse(readFileSync(file, 'utf8')).products) add('product', entry);
}

const base = { code: 'P00022', title: 'Produto', link: 'https://loja.example.com/p/1' };
...
const codes = ['P00022', 'P0022', 'P000022', 'P00001', 'P99999', 'P100000', 'P123456789', 'P12345678', 'P00000', 'P0000', 'P' + '0'.repeat(15),
  'P' + '0'.repeat(16), 'p00022', 'P00022\n', 'P0022\n', 'P022', 'P22', 'P' + char(0x662, 0x662, 0x662, 0x662, 0x662), ' P00022', 'P00022 ',
  'P00000000000001', 'P-00022', '#P00022'];
...
add('product', { code: 'P00022', title: 'sem link' });
